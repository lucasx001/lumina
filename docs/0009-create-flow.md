...
保留次级图片编辑入口，可从同一 Sheet 进入选图、上传和现有图片编辑流程。
...
Sheet 与生成基础已有；风格必选、类型选择、任务恢复、归档导航、图片编辑入口和结果操作见 C02–C04、E02、N01–N02。

## 验收标准

- [x] 主流程只需风格、提示词和类型，点击生成产出一张作品。
- [ ] 下滑/返回/键盘行为和生成中的关闭重开通过验证。
- [x] 成功可从首页类型找到该作品，图片编辑入口可达。
